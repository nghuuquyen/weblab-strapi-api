...
export interface ApiCourseObjectiveCourseObjective
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    learning_outcomes: Schema.Attribute.Relation<
      'oneToMany',
      'api::learning-outcome.learning-outcome'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::course-objective.course-objective'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    code: Schema.Attribute.String;
    course_objectives: Schema.Attribute.Relation<
      'oneToMany',
      'api::course-objective.course-objective'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiLearningOutcomeLearningOutcome
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    code: Schema.Attribute.String;
    course: Schema.Attribute.Relation<'manyToOne', 'api::course.course'>;
    course_objective: Schema.Attribute.Relation<
      'manyToOne',
      'api::course-objective.course-objective'
    >;
    createdAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::course-objective.course-objective': ApiCourseObjectiveCourseObjective;
      'api::course.course': ApiCourseCourse;
      'api::global.global': ApiGlobalGlobal;
      'api::learning-outcome.learning-outcome': ApiLearningOutcomeLearningOutcome;
